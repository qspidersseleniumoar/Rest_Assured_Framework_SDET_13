...
public class AddSingleProjectWithCompletedStatus3 extends BaseClass{
	...
	public void addSingleProjectWithCreatedStatus() throws Throwable {
		...
		Project pobj = new Project("deepak", projNAme, "Completed", 10);
		
		Response resp = given()                               // pre conditions
						  .contentType(ContentType.JSON)
						  .body(pobj)
						.when()                             // actual http test
						   .post(IEndPoints.addSingleProjectWithCompletedStatus2);
