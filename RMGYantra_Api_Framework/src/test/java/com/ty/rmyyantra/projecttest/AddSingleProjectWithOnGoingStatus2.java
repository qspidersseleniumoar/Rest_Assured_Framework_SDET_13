...
public class AddSingleProjectWithOnGoingStatus2 extends BaseClass{
	
	@Test
	public void addSingleProjectWithOnGoingStatus() throws Throwable {

		String projNAme = "JhonyWalkerWhisky_"+JavaUtility.getRanDomNum();
		
		Project pobj = new Project("deepak", projNAme, "On Going", 10);
		
		Response resp = given()                               // pre conditions
						  .contentType(ContentType.JSON)
						  .body(pobj)
						.when()                             // actual http test
						   .post(IEndPoints.addSingleProjectWithOnGoingStatus);
